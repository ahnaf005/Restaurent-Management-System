...
public class InsertCustomerController {
    ...
    void createAccount(ActionEvent event)
    {
        ...
        else
        {
            ...
            if(success)
            {
                DBGetCustomer customerDetails = new DBGetCustomer();
                customerDetails.showCustomerID(phoneNo,email,password);
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Success");
                alert.setHeaderText("Customer ID: "+customerDetails.getCustomerID());
